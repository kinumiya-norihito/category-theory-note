const
    recursive_make = (parent, elems, h_level, app_num) => {
        ...
        for (const elem of elems) {
            ...
            recursive_make(li_elem, elem.parentElement.getElementsByTagName(`h${+elem.tagName.match(/\d/)[0] + 1}`), h_level + 1, app_num);
            index++;
        }
        app_num.pop();
    };
...
window.onload = () => {
    recursive_make(document.getElementById("outline"), document.getElementsByTagName("h2"), 0, []);
};